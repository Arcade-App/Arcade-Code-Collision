...
public class ProfileTop3GameButton : MonoBehaviour
{
    ...
    public void OnChooseProfileTop3GameButtonClicked()
    {

        StartCoroutine(OnChooseProfileTop3GameButtonClickedCoroutine());
    
    }


    public IEnumerator OnChooseProfileTop3GameButtonClickedCoroutine()
    {
        ...
        Manager.instance.canvasManager.profilePanelGO.SetActive(false);
