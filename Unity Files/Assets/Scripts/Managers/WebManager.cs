...
public class WebManager : MonoBehaviour
{
    ...
    //string servername = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/";
    
    [Header("Server Settings")]
    string registerUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/RegisterUser.php";
    string updateWalletUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/UpdateWallet.php";
    string signInUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/SignInUser.php";
    string storeGameUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/StoreCreatedGame.php";
    string getUserGamesUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/GetUserGames.php";
    string storeTournamentUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/StoreCreatedTournament.php";
    string getTournamentManagerUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/GetTournamentManagerAddress.php";
    string getUserTournamentsUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/GetUserTournaments.php";
    string getTop30GamesUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/GetTop30Games.php";
    string getAllTournamentsUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/GetAllTournaments.php";
    string getUserJoinedTournamentDetailsUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/GetUserJoinedTournaments.php";
    string getTournamentScoresUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/GetTournamentScores.php";
    string storeTournamentScoreUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/StoreTournamentScore.php";
    string getGameTemplateIdUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/GetGameTemplateId.php";
    string getOrCreateGameScoreUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/GetOrCreateGameScore.php";
    string updateGameScoreUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/UpdateGameScore.php";
    string incrementGamePlayCountUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/IncrementGamePlayCount.php";
    string getGameDetailsUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/GetGameDetails.php";
    string getOrCreateTournamentScoreUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/GetOrCreateTournamentScore.php";
    string incrementTournamentPlayCountUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/IncrementTournamentPlayCount.php";
    string incrementTournamentUserCountUrl = "https://yellow-bison-657284.hostingersite.com/aptoshackbackend/IncrementTournamentUserCount.php";
        ...
        using (UnityWebRequest www = UnityWebRequest.Get(getTournamentManagerUrl))
        {
            ...
            else
            {
                ...
                if (responseData.status == "success")
                {
                    ...
                    Manager.instance.walletManager.SetTournamentManagerData(tournamentManagerAddress, tournamentContractName);
                }
                else
                {
