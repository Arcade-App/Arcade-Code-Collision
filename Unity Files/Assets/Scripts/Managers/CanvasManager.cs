...
public class CanvasManager : MonoBehaviour
{
    ...
    [Header("Aptos Balance Group")]
    public TMP_Text aptosBalanceText;
    ...
    public IEnumerator PopulateLivePastTournamentHomePanel()
    {
        if(Manager.instance.tournamentDataManager.livePrizePoolList.Count != 0)
        {
            ...
            homePanelTournamentPrizePoolText.text = TruncateToTwoDecimalPlaces(Manager.instance.tournamentDataManager.livePrizePoolList[liveHighestPrizePoolIndex]) + " APT";
        ...
        else
        {
            ...
            if(Manager.instance.tournamentDataManager.pastPrizePoolList.Count != 0)
            {
                ...
                homePanelTournamentPrizePoolText.text = TruncateToTwoDecimalPlaces(Manager.instance.tournamentDataManager.pastPrizePoolList[pastHighestPrizePoolIndex]) + " APT";
                                                           ...
                                                           Sprite tournamentSprite, Color tournamentColor ,string endingIn)
    {
        ...
        joinedTournamentButtonPrizeText.text = prizePool + " APT Prize";
    ...
    {
        // Base URL for Aptos explorer
        string baseUrl = "https://explorer.aptoslabs.com/account/";

        // Specify the network (testnet in this case)
        string network = "?network=testnet";
    ...
    public void OnPrizeDetailsNextClicked()
    {
        ...
        confirmationPanelWalletBalanceText.text = TruncateToTwoDecimalPlaces(Manager.instance.userInfoManager.walletBalanceFloat) + " APT";

        confirmationPanelConfirmationText.text = "You will be transferring <b><color=#42EFEC>" + Manager.instance.tournamentDataManager.prizePool + " APT</color></b> to Tournament Contract & winners will receive the prizes after tournament ends!";    
    ...
    public IEnumerator PopulateRecentTournamentProfilePanel()
    {
        ...
        if(tournamentDataListLength != 0)
        {
            ...
            profileTournamentButtonPrizePoolText.text = TruncateToTwoDecimalPlaces(Manager.instance.tournamentDataManager.userPrizePoolList[tournamentDataListLength - 1]) + " APT";
